...
const HeroIllustration = () => {
  return (
    <div
      className="p-12 absolute w-[30vw] top-[-10%] right-[-3vw] -translate-y-[10%] 2xl:left-1/2 2xl:max-w-[400px] 2xl:translate-y-20 max-md:min-w-[300px] max-md:translate-y-1/2 max-md:bottom-[-40%] max-md:right-[-8rem] max-md:opacity-30 max-md:pointer-events-none max-md:[&_.hero-illustration-card]:opacity-80 select-none"
      style={{
        perspective: "100px",
