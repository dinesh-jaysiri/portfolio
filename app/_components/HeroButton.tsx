...
function HeroButton() {
  return (
    <div
      className="rounded-l-full p-3 inline-flex bg-gradient-to-r from-[#0F3324]/25 to-[#0F3324]/0 -ml-3 mb-7 translate-x--4"
      data-fade="0"
    >
      <div className="rounded-l-full px-4 py-2.5 sm:px-6 sm:py-3.5 inline-flex items-center gap-4 bg-gradient-to-r from-[#0F3324] to-[#0F3324]/0">
        {/* Accent Circle */}
